...
public class MainActivityFragment extends Fragment {
   ...
   private void loadNextFlag() {
      ...
      // get an InputStream to the asset representing the next state
   ...
   // parses the state file name and returns the state name
   ...
   private void animate(boolean animateOut) {
      // prevent animation into the the UI for the first state
      if (correctAnswers == 0)
         return;
   ...
   private OnClickListener guessButtonListener = new OnClickListener() {
      ...
      public void onClick(View v) {
         ...
         if (guess.equals(answer)) { // if the guess is correct
            ...
            // if the user has correctly identified STATES_IN_QUIZ flags
